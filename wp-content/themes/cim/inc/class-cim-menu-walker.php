<?php
/**
 * Custom Menu Walker for CIM Theme
 *
 * @package CIM
 */

if ( ! class_exists( 'CIM_Menu_Walker' ) ) :

/**
 * Custom Menu Walker Class
 * 
 * Extends Walker_Nav_Menu to add custom markup for dropdown menus
 */
class CIM_Menu_Walker extends Walker_Nav_Menu {
