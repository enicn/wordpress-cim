...
add_action('admin_menu', 'cim_add_news_page_settings_menu');
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php echo esc_html__('This post will be displayed as the large featured post on the left side.', 'cim'); ?></p>
                    </td>
                </tr>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="url" name="cim_news_video_url" id="cim_news_video_url" value="<?php echo esc_attr($video_url); ?>" class="regular-text">
                        <p class="description"><?php echo esc_html__('Enter the URL for the video (YouTube, Vimeo, etc.).', 'cim'); ?></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="cim_news_video_title" id="cim_news_video_title" value="<?php echo esc_attr($video_title); ?>" class="regular-text">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="cim_news_video_subtitle" id="cim_news_video_subtitle" value="<?php echo esc_attr($video_subtitle); ?>" class="regular-text">
                    </td>
                </tr>
            </table>
